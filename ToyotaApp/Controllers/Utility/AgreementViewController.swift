...
1.2. Настоящая политика Оператора в отношении конфиденциальности персональных данных (далее – Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта, пользователей мобильного приложения.
...
2.7. Оператор – юридическое или физическое лицо, самостоятельно или совместно с другими лицами организующие или осуществляющие обработку персональных данных, а также определяющие цели обработки персональных данных, состав персональных данных, подлежащих обработке, действия (операции), совершаемые с персональными данными;
2.8. Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю использующего сервисы Оператора;
...
3.3 Электронные данные (HTTP-заголовки, IP-адрес, файлы cookie, веб-маяки/пиксельные теги, данные об идентификаторе браузера, информация об аппаратном и программном обеспечении);
3.4 Дата и время осуществления доступа к Сервису;
3.5 Информация о Вашей активности во время использования Сервиса, включая гео локационные данные;
3.6. Вышеперечисленные данные далее по тексту Политики объединены общим понятием Персональные данные.
3.7 Мы собираем Ваши персональные данные, когда Вы соглашайтесь предоставлять их нам в ходе регистрации в отношении и/или в ходе использования Сервисов, например, мы можем получить Ваше имя, номер телефона и адрес электронной почты.
3.8 Вы несете ответственность за проверку и обеспечение того, чтобы вся информация, контент, материалы или данные, которые вы нам предоставляете, были верными, полными, точными и не вводящими в заблуждение.
3.9 Наши сервисы могут попросить Вас предоставить персональные данные добровольно. Например, мы запросим определенные данные с тем, чтобы вы зарегистрировали учетную запись у нас, чтобы Вы могли начать использование Сервисов, чтобы Вы могли подписаться на маркетинговую рассылку от нас, и/или предоставлять нам запросы, такие, как:
Контактную информацию и данные для ведения корреспонденции (такие, как имя и электронный адрес);
Имя пользователя и пароль;
Информацию о профиле;
Иные данные, которые вы решите нам дать (такие, как данные для идентификации утерянной учетной записи).
4. Цели обработки персональных данных
4.1. Цель обработки персональных данных Пользователя — заключение, исполнение и прекращение гражданско-правовых договоров, лицензионных соглашений; предоставление доступа Пользователю к сервисам, информации и/или материалам.
4.2. Также Оператор имеет право направлять Пользователю уведомления о новых продуктах и услугах, специальных предложениях и различных событиях. Пользователь всегда может отказаться от получения информационных сообщений, направив Оператору письмо на адрес электронной почты alyans.developer@gmail.ru с пометкой «Отказ от уведомлений о новых продуктах и услугах и специальных предложениях».
...
5.6 В случае получения сервисов Оператора с помощью Google Play или Apple App Store, мы будем использовать только разрешенную и общедоступную информацию для оптимизации наших Сервисов.
5.7 Мы не публикуем и не раскрываем непредназначенные для широкой общественности контакты или персональные данные без разрешения осуществить это.
5.8 Информация, которая может быть собрана автоматически
Когда Вы используете наши Сервисы, мы также можем автоматически собирать данные от Вас и/или с Вашего устройства, которые могут считаться персональными данными в соответствии с применимыми законами о защите персональных данных, такие как:
Данные и аналитику об использовании Вами наших Сервисов;
Ваш IP адрес и идентификаторы мобильного устройства, такие, как идентификационный номер Вашего устройства, МАС-адрес, IMEI);
...
При условии получения вашего предварительного согласия, мы можем использовать Ваши персональные данные:
1. чтобы предоставить Вам доступ и возможность использования Сервисов:
Для создания учетных записей пользователей и профилей;
Для идентификации и проверки спама или идентификаторов нежелательного вызывающего абонента;
Для предоставления Вам корректных версий наших приложений; и
...
8.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты alyans.developer@gmail.ru.
8.2. В данном документе будут отражены любые изменения политики обработки персональных данных Оператором. Политика действует бессрочно до замены ее новой версией.
10. Изменения данной Политики конфиденциальности
