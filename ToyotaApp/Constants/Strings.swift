...
extension String {
    ...
    enum CommonStrings: String {
        ...
        case thanksForRegister = "Благодарим за регистрацию!"
        /// В главном меню Вы сможете  воспользоваться различными услугами по обслуживанию автомобилей и не только.
        case appFeatures = "В главном меню Вы сможете  воспользоваться различными услугами по обслуживанию автомобилей и не только."
